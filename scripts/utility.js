...
async function analyzingNew(inputFile) {
...
// add conditions parameter
async function reconstructSubstitutionNew(wordFile, sentenceFile) {
    // needs a list of words and list of sentences -> works with analyze function
...
module.exports = { analyzing, analyzingNew, reconstructSubstitution, reconstructSubstitutionNew, reconstructBlackout, markovReconstruct, reconstructWhitespace }